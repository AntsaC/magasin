...
<div class="container">
    ...
    <div class="card w-50">
        <div class="card-body mt-3">
            <form method="post" action="{{ route('receptions.magasin.validation', $transfer) }}">
                @csrf
                 <div class='form-group'>
                    <label for='received'>Received</label>
                    <input type='number' name='quantity_received' id='received' value='{{ old('quantity_received') ?? $transfer->quantity_sent }}' class='form-control @error('quantity_received') is-invalid @enderror' />@error('quantity_received')
